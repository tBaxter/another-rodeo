...
if (title !== null) {
  ...
  let tags = window.prompt('Tags (as a comma-separated list)', 'link')
...
`;
    ...
    let newFileUrl = `https://github.com/tbaxter/another-rodeo/new/main/?filename=${filename}&value=${encodeURIComponent(
      value
